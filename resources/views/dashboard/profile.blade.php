        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="card hover-effect card-light-primary mt-4">
                            <div class="card-body">
                                ...
                                <div class="progress w-100 mt-3 mb-3" role="progressbar" aria-valuenow="0"
                                    aria-valuemin="0" aria-valuemax="100">
                                    <div class="progress-bar bg-primary progress-bar-striped" style="width: 78.5%">
                                    </div>
                                </div>
                        ...
                        <div class="d-flex align-items-center">
                            <span class="h-45 w-45 d-flex-center bg-warning b-r-50 position-relative">
                                <img src="../assets/images/avtar/09.png" alt="avtar" class="img-fluid b-r-50">
                                <span
            ...
            <div class="col-lg-8 col-xxl-9">
                <div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Maria C. Eck">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                    ...
                                    <div class="tab-pane fade show active" id="today-tab-pane" role="tabpanel"
                                        ...
                                        <ul class="app-timeline-box activity-timeline">
                                            ...
                                            <li class="timeline-section">
                                                ...
                                                <div class="timeline-content">
                                                    <p class=" f-s-16 text-info mb-0">2 image files and 2 videos
                                                        uploaded</p>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <a href="../assets/images/draggable/02.jpg"
                                                                    class="glightbox img-hover-zoom"
                                                                    data-glightbox="type: image; zoomable: true;">
                                                                    <img src="../assets/images/draggable/02.jpg"
                                                                        class="w-100 rounded" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <a href="../assets/images/draggable/04.jpg"
                                                                    class="glightbox img-hover-zoom"
                                                                    data-glightbox="type: image; zoomable: true;">
                                                                    <img src="../assets/images/draggable/04.jpg"
                                                                        class="w-100 rounded" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <a href="../assets/images/draggable/01.jpg"
                                                                    class="glightbox img-hover-zoom"
                                                                    data-glightbox="type: image; zoomable: true;">
                                                                    <img src="../assets/images/draggable/01.jpg"
                                                                        class="w-100 rounded" alt="">
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="timeline-content">
                                                    <div class="f-s-16">
                                                        <span class="text-secondary"><span
                                                                class="text-success f-s-16 mb-0">Dane Wiza</span> added
                                                            reaction in <span
                    ...
                    <div class="tab-pane fade" id="security-tab-pane" role="tabpanel" aria-labelledby="security-tab"
                                ...
                                <div class="account-security">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-4 account-security-img">
                                            <img src="../assets/images/setting-app/account.jpg" alt="" class="w-180">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row security-box-card align-items-center">
                                    <div class="col-md-3 position-relative">
                                        <span><img src="../assets/images/setting-app/google.png" alt=""
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row security-box-card align-items-center">
                                    <div class="col-md-3 position-relative">
                                        <span class="bg-primary h-35 w-35 d-flex-center b-r-50 anti-code">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row security-box-card align-items-center">
                                    <div class="col-md-3 position-relative">
                                        <span class="bg-success h-35 w-35 d-flex-center b-r-50 anti-code">
                                ...
                                <div class="account-security">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-3 account-security-img">
                                            <img src="../assets/images/setting-app/device.jpg" alt="" class="w-150">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                            ...
                                            <div class="card-body">
                                                <div class="device-menu-item" draggable="false">
                                                    ...
                                                    <div class="device-menu-content">
                                                        ...
                                                        <p class="mb-0 txt-ellipsis-1 text-secondary">switzerland
                                                            201.36.24.108</p>
                                                    </div>
                            ...
                            <div class="col-lg-12 col-xxl-6">
                                <ul class="active-device-session  active-device-list" id="shareMenuRight">
                                    <li>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="device-menu-item " draggable="false">
                            ...
                            <div class="card-body">
                                <div class="account-security mb-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-3 account-security-img">
                                            <img src="../assets/images/setting-app/password.jpg" alt="" class="w-150">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="privacy-tab-pane" role="tabpanel" aria-labelledby="privacy-tab"
                        tabindex="0">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox1">
                                                    <span class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="privacy-content ms-5 me-2">
                                                            <span
                                                                class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Private</span>
                                                            <span class="mb-0 text-secondary f-s-16"> only users you
                                                                choose can access</span>
                                                        </span>
                                                    </span>
                                                </label>

                                                <input class="form-check-input form-check- b-r-100 w-25 h-25"
                                                    type="radio" id="inlineCheckbox1" name="option" value="option1"
                                                    checked>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="select-item ">
                                                <label class="form-check-label" for="inlineCheckbox2">
                                                    <span class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="privacy-content ms-5 me-2">
                                                            <span
                                                                class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Public</span>
                                                ...
                                                <input class="form-check-input b-r-100 w-25 h-25" type="radio"
                                                    id="inlineCheckbox2" name="option" value="option2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="select-item">
                                                <label class="form-check-label" for="inlineCheckbox3">
                                                    <span class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="privacy-content ms-5 me-2">
                                                            <span
                                                                class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">users
                                                                in the table
                                                            </span>
                                                ...
                                                <input class="form-check-input b-r-100 w-25 h-25" type="radio"
                                                    id="inlineCheckbox3" name="useroption" value="useroption1" checked>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" col-xxl-6">
                                            ...
                                            <div class="select-item">
                                                <label class="form-check-label" for="inlineCheckbox4">
                                                    <span class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="privacy-content ms-5 me-2">
                                                            <span class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">
                                                                production team
                                                            </span>
                                                            <span class="mb-0 text-secondary f-s-16">
                                                ...
                                                <input class="form-check-input b-r-100 w-25 h-25" type="radio"
                                                    id="inlineCheckbox4" name="useroption" value="useroption2" checked>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" col-xxl-6">
                                            ...
                                            <div class="select-item">
                                                <label class="form-check-label" for="inlineCheckbox5">
                                                    <span class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="privacy-content ms-5 me-2">
                                                            <span
                                                                class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Anyone
                                                                from domain</span>
                                                            <span class="mb-0 text-secondary f-s-16">
                                                                users
                                                ...
                                                <input class="form-check-input b-r-100 w-25 h-25" type="radio"
                                                    id="inlineCheckbox5" name="useroption" value="useroption3" checked>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" col-xxl-6">
                                            ...
                                            <div class="select-item">
                                                <label class="form-check-label" for="inlineCheckbox6">
                                                    <span class="d-flex align-items-center position-relative">
                                                        ...
                                                        <span class="privacy-content ms-5 me-2">
                                                            <span
                                                                class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Any
                                                                email in table</span>
                                                            <span class="mb-0 text-secondary f-s-16">Anyone
                                                ...
                                                <input class="form-check-input b-r-100 w-25 h-25" type="radio"
                                                    id="inlineCheckbox6" name="useroption" value="useroption4" checked>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" col-xxl-12">
                                        <div class="publishe-card">
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-light-primary">Unpublish</button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="notification-email">
                                                ...
                                                <div class="select-item">
                                                    <input class="form-check-input form-check-primary w-25 h-25"
                                                        type="checkbox" id="checkbox-email" value="option1">
                                                    <label class="form-check-label" for="checkbox-email">
                                                        <span class="d-flex align-items-center position-relative">

                                                            <span class="ms-3 privacy-content">
                                                                <span
                                                                    class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Comments</span>
                                                ...
                                                <div class="select-item">
                                                    <input class="form-check-input form-check-primary w-25 h-25"
                                                        type="checkbox" id="checkbox-email1" value="option2">
                                                    <label class="form-check-label" for="checkbox-email1">
                                                        <span class="d-flex align-items-center">

                                                            <span class="ms-3 privacy-content">
                                                                <span
                                                                    class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Condidates</span>
                                                                <span class="text-secondary mb-0"> notified
                                                ...
                                                <div class="select-item">
                                                    <input class="form-check-input form-check-primary w-25 h-25"
                                                        type="checkbox" id="checkbox-email2" value="option3">
                                                    <label class="form-check-label" for="checkbox-email2">
                                                        <span class="d-flex align-items-center">

                                                            <span class="ms-3 privacy-content">
                                                                <span
                                                                    class="mb-0 text-dark txt-ellipsis-1 f-s-16 f-w-500">Offers</span>
                                                                <span class="text-secondary mb-0"> notified
                                            ...
                                            <div class="notification-push">
                                                ...
                                                <div class="d-flex align-items-center gap-1 mt-3">
                                                    <input class="form-check-input form-check-primary f-s-18 mb-1 m-1"
                                                        type="radio" name="flexRadioDefault" id="radio_default1">
                                                ...
                                                <div class="d-flex align-items-center gap-1 mt-3">
                                                    <input class="form-check-input form-check-primary f-s-18 mb-1 m-1"
                                                        type="radio" name="flexRadioDefault" id="radio_default2">
                                                ...
                                                <div class="d-flex align-items-center gap-1 mt-3">
                                                    <input class="form-check-input form-check-primary f-s-18 mb-1 m-1"
                                                        type="radio" name="flexRadioDefault" id="radio_default3">
                                                    <label class="form-check-label" for="radio_default3">
                                            ...
                                            <li>
                                                <div class="share-menu-item mb-4">
                                                    <span
                                                        ...
                                                        <i class="ph-bold  ph-device-mobile-speaker f-s-30"></i>
                                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6">
                                            ...
                                            <div class="form-selectgroup mt-5">
                                                <div class="select-item">
                                                    <input class="form-check-input form-check-primary w-20 h-20"
                                                        type="radio" id="planCheckbox1" value="planoption1"
                                                        name="planoption" checked>
                                                    <label class="form-check-label" for="planCheckbox1">
                                                        <span class="d-flex align-items-center">
                                                            <span class="ms-2">
                                            ...
                                            <div class="form-selectgroup mt-4">
                                                <div class="select-item">
                                                    <input class="form-check-input form-check-primary w-20 h-20"
                                                        type="radio" id="planCheckbox2" value="planoption2"
                                                        name="planoption">
                                                    <label class="form-check-label" for="planCheckbox2">
                                                        <span class="d-flex align-items-center">
                                                            <span class="ms-2">
                                                                <span class="fs-6 mb-0">Mark Moen</span>
                                            ...
                                            <div class="form-selectgroup mt-4">
                                                <div class="select-item">
                                                    <input class="form-check-input form-check-primary w-20 h-20"
                                                        type="radio" id="planCheckbox3" value="planoption3"
                                                        name="planoption">
                                                    <label class="form-check-label" for="planCheckbox3">
                                                        <span class="d-flex align-items-center">
                                                            <span class="ms-2">
                                        ...
                                        <div class="col-xxl-6 mt-xxl-0 mt-5">
                                            <div class="plan-choose">
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-light-primary">Credit
                                                        card</button>
                                                    <button type="button"
                                            ...
                                            <div class="form-selectgroup mt-5">
                                                <div class="select-item d-flex">
                                                    <input class="form-check-input form-check-primary w-20 h-20"
                                                        type="radio" id="paymentCheckbox1" value="paymentoption1"
                                                        name="paymentoption">
                                                    <label class="form-check-label" for="paymentCheckbox1">
                                                        <span class="d-flex align-items-center">
                                                            <span class="ms-2">
                                                    ...
                                                    <div class="ms-2">
                                                        <img src="../assets/images/icons/visa-icon.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-selectgroup mt-4">
                                                <div class="select-item d-flex">
                                                    <input class="form-check-input form-check-primary w-20 h-20"
                                                        type="radio" id="paymentCheckbox2" value="paymentoption2"
                                                        name="paymentoption" checked>
                                                    <label class="form-check-label" for="paymentCheckbox2">
                                                        <span class="d-flex align-items-center">
                                                            <span class="ms-2">
                                            ...
                                            <div class="form-selectgroup p-3 mt-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control form-check-primary b-r-left"
                                                        placeholder="20FGJKYSD" aria-label="Recipient's username"
                                                        aria-describedby="button-addon2">
                                                    <button class="btn btn-secondary b-r-right" type="button"
                    ...
                    <div class="tab-pane fade" id="Connection-tab-pane" role="tabpanel" aria-labelledby="Connection-tab"
                        tabindex="0">
                        <div class="row">
                                        ...
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/geethub.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-7"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/slack.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-8"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/google.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-9"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/figma.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-10"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/drive.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-11"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/drop-box.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-12"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/facebook.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-13"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/instagram.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-14"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/twitter.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <input class="form-check-input  form-check-primary  fs-3"
                                                    type="checkbox" id="basic-switch-15" checked="">
                                                <label class="form-check-label pt-2" for="basic-switch-15"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/dribble.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-16"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/linkdin.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-17"></label>
                                            </div>
                                        </div>
                                ...
                                <div class="card conection-setting">
                                    <div class="card-body">
                                        <div class="conection-item">
                                            <div class="position-relative">
                                                <span class="position-absolute">
                                                    <img src="../assets/images/setting-app/behance.png" alt=""
                                                        class="w-35 h-35">
                                                </span>
                                            ...
                                            <div class="form-check form-switch d-flex mt-1">
                                                ...
                                                <label class="form-check-label pt-2" for="basic-switch-18"></label>
                                            </div>
                                        </div>
