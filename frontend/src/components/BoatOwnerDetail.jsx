...
const BoatOwner = () => {
  ...
  return (
    ...
    <div className="text-center mb-10">
           ...
           <h2 className="text-3xl sm:text-4xl font-bold text-red-500 mt-4">
            Boat Owner Managmenet
           </h2>
      ...
      {activeTab === 'register' ? (
        <form onSubmit={handleSubmit}>
          {/* <h1 className="text-2xl font-bold text-center text-gray-800 mb-6">Boat Owner Registration</h1> */}
...
<div className='bg-white rounded-lg shadow-md p-4 '>
          ...
          {/* Family Info */}
          <div className="mb-8">
            <label htmlFor="family" className="block text-gray-700 font-medium mb-2">Family Members *</label>
            <textarea
              id="family"
              ...
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
              placeholder="Enter family members details (Name, Age, Relation)"
            ></textarea>
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="px-8 py-2 bg-rose-500 text-white rounded-full focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 font-bold"
            >
